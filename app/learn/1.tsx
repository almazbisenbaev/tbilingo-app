...
export default function LevelAlphabetScreen() {
  ...
  const [sessionItems, setSessionItems] = useState<AlphabetItem[]>([]);
      ...
      <ScrollView className="flex-1">
        ...
        {isFinished ? (
            <View className="items-center">
                ...
                <Text className="text-muted-foreground text-center mb-6">You have mastered all letters in this course.</Text>
