  ...
  if (error) {
    return (
      <View className="flex-1 justify-center items-center bg-background p-6">
        ...
        <Button onPress={router.back} variant="secondary" title="Go Back" className="px-6 py-3" />
      </View>
    );
  }
        ...
        <View className="bg-card border-b border-border">
          <View className="flex-row items-center p-4 w-full max-w-[640px] self-center">
            ...
            <View className="flex-1 mx-2">
              <ProgressBar current={currentIndex} total={sessionItems.length} height={8} />
            </View>
            <View className="w-8" />
          </View>
        </View>
