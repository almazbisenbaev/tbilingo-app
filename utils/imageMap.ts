export const imageMap: Record<string, any> = {
  '/images/icon-alphabet.svg': require('../assets/images/icon-alphabet.svg'),
  '/images/icon-phrases.svg': require('../assets/images/icon-phrases.svg'),
  '/images/icon-numbers.svg': require('../assets/images/icon-numbers.svg'),
